...
export default function Projects() {
  return (
    <section id="projects" className="relative py-20 sm:py-32 z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 max-w-7xl mx-auto">
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="h-36 sm:h-48 w-full bg-gradient-to-br from-navy-800 to-navy-900 relative overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-24 sm:h-24 border border-white/20 rounded-full group-hover:scale-110 transition-transform duration-700 ease-out flex items-center justify-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 border border-electric-blue/40 rounded-full group-hover:rotate-90 transition-transform duration-1000" />
                </div>
              </div>

              <div className="p-5 sm:p-6 flex-1 flex flex-col">
                <h3 className="text-lg sm:text-2xl font-bold text-white mb-2 sm:mb-3 group-hover:text-electric-blue transition-colors">
                  {project.title}
                </h3>
                <p className="text-gray-400 text-sm mb-4 sm:mb-6 flex-1">
                  {project.description}
                </p>
                ...
                <div className="flex gap-4 pt-3 sm:pt-4 border-t border-white/10">
