          ...
          >
            {[
              ...
              <motion.div
                ...
                className="glass p-4 sm:p-6 rounded-2xl border border-white/10 hover:border-electric-blue/50 transition-colors group relative overflow-hidden"
              >
                ...
                <item.icon className="w-6 h-6 sm:w-8 sm:h-8 text-electric-blue mb-3 sm:mb-4" />
