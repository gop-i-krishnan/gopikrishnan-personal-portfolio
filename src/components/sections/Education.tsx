...
export default function Education() {
  return (
    <section id="education" className="relative py-32 z-10 bg-navy-800/30">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div>
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-2">B.Tech in Electronics and Communication Engineering</h3>
          ...
          <div>
            ...
            >
              <h2 className="text-3xl font-bold flex items-center gap-3">
                <Award className="text-electric-purple" size={32} />
                Achievements
              </h2>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 0.6 }}
              className="glass p-8 rounded-2xl border border-electric-purple/20 relative overflow-hidden group"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-full border border-electric-purple/30 flex items-center justify-center text-electric-purple text-xl font-bold box-glow">
                    #1
                  </div>
