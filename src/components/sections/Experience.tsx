      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            ...
            <div className="w-full md:w-5/12 pl-12 md:pl-0 md:text-right md:pr-12">
              ...
              <div className="flex items-center gap-4 md:justify-end text-gray-400 text-sm mb-4">
            ...
            <div className="w-full md:w-5/12 pl-12 md:pl-12 mt-4 md:mt-0">
              <div className="glass p-6 rounded-2xl border border-white/10 hover:border-electric-purple/40 transition-colors">
